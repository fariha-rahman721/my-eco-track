...
const AddNewChallenge = ({ onBack, onSave }) => {
  ...
  return (
    <div className="w-11/12 mx-auto lg:w-11/12">
        <Navbar></Navbar>
    <div className="min-h-screen w-11/12 mx-auto bg-gray-50 pt-24 pb-12 lg:w-11/12">
      <div className="max-w-3xl mx-auto px-4">
        
        {/* Back Button */}
        <Link to='/'
          onClick={onBack}
          className="flex items-center text-gray-500 hover:text-emerald-600 font-medium mb-6"
        >
